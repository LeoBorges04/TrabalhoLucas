...
public class PacienteRequestDto {
        ...
        @Pattern(regexp = "\\d{10,11}", message = "telefone deve conter 10 ou 11 digitos numéricos")
        ...
        @NotBlank(message = "campo numeroCarteirinha é obrigatório")
        private String numeroCarteirinha;

        @NotBlank(message = "campo convenio é obrigatório")
